...
if (isset($_GET['token']) && !empty($_GET['token'])) {
    ...
    die("Aucun jeton de sécurité fourni.");
}
?>
...
<head>
    <meta charset="UTF-8">
    <title>Nouveau mot de passe - Lobody Formation</title>
    ...
    <main class="login-container">
        <section class="glass-card">
            ...
            <div class="form-section">
                <h1>Création de votre nouveau mot de passe</h1>
                    <form method="POST" action="reinitialisation.php?token=<?= htmlspecialchars($token) ?>">
                    
                        <div class="input-group">
                            <label for="confirmation_mdp">Nouveau mot de passe :</label>
                            <div class="input-wrapper">
                                ...
                                <input type="password" id="nouveau_mdp" name="nouveau_mdp" placeholder="••••••••" required>
                            </div>
                        </div>
                        ...
                        <button type="submit" class="submit-btn">Enregistrer le mot de passe</button>
                    </form>
